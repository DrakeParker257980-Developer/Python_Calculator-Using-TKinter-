...
root.title('Calculator By Drake Parker')
...
status_var.set('Ready..')
Label(root,textvariable=status_var,relief=SUNKEN,anchor='w',borderwidth=3,bg='cyan',fg='crimson').pack(side=BOTTOM,fill=X)
